...
public:
	...
	static const int SUPER_BLOCK_SECTOR_NUMBER = 1000;	/* 定义SuperBlock位于磁盘上的扇区号，占据1000，1001两个扇区。 */
	...
	static const int INODE_ZONE_START_SECTOR = 1002;		/* 外存Inode区位于磁盘上的起始扇区号 */
	static const int INODE_ZONE_SIZE = 2000 - INODE_ZONE_START_SECTOR;		/* 磁盘上外存Inode区占据的扇区数 */

	static const int DATA_ZONE_START_SECTOR = 2000;		/* 数据区的起始扇区号 */
